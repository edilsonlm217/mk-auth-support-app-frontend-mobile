    ...
    <View style={styles.container}>
      <View style={styles.header_container}>
        ...
        <View style={{ marginLeft: 10 }}>
          ...
          <Text style={styles.sub_text}>
            <Text style={styles.sub_text}>
              {`${
                props.data.plano === 'nenhum' ? 'Nenhum' : props.data.plano
              } | ${props.data.tipo.toUpperCase()} | ${
                props.data.ip === null ? 'Nenhum' : props.data.ip
              }`}
            </Text>
          </Text>
        </View>
      ...
      <View style={styles.line_container}>
        ...
        <Text style={styles.main_text}>
          {props.data.mensagem ? props.data.mensagem : 'Sem comentários'}
        </Text>
      </View>
      <View style={styles.line_container}>
